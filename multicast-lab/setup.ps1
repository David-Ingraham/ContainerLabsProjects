...
Write-Host "Multicast Lab Infrastructure Setup" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
docker run --rm --network container:clab-multicast-lab-gobgp1 --privileged alpine sh -c "sysctl -w net.ipv4.ip_forward=1 && ip route add 10.1.0.0/24 via 10.0.1.2"
...
Write-Host ""
Write-Host "  - Data Plane:  10.0.1.0/29"
Write-Host "    - FRR1:   10.0.1.2"
Write-Host "    - GoBGP1: 10.0.1.3"
Write-Host ""
Write-Host "  - Backend Networks:"
Write-Host "    - FRR1:   10.1.0.2/24 (host1: 10.1.0.10)"
